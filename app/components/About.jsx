        ...
        <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
          ...
          <div className='flex-1'>
            <p className='mb-10 max-w-2xl font-Ovo'>
              I'm an experiened mobile app developer who has worked over 20 applications and published 
              6 of them on the Google Play Store and Apple App Store.
            </p>
            ...
            <h4 className='my-6 text-gray-700 font-Ovo'> Toools I use</h4>
