...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "b62d511b-30ca-42e1-89d2-7a87c6915a34");
  ...
  return (
    ...
    bg-no-repeat bg-center bg-[length:90%_auto dark:bg-none">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        I'd love to hear from you! If you have any questions, comments, or feedbacks, 
      ...
      <form className='max-w-2xl mx-auto' onSubmit={onSubmit}>
        ...
        <textarea row='6' placeholder='Enter your message' required
