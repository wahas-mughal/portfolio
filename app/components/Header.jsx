...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 pt-20'>
        ...
        <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'> Hi, I'm Wahas Ali Mughal 
        ...
        <p className='max-w-2xl mx-auto font-Ovo '> 
            I'm a mobile app developer from Karachi, Pakistan with 4 years of experience in developing cross-platform
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            className='px-10 py-3 border rounded-full border border-gray-500 flex items-center gap-2'>my resume 
