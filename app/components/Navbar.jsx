    ...
    ${
      ...
      >
        ...
        >
          ...
          <li>
            <a className="font-Ovo" onClick={closeMenuHandler} href="#top">
              Home
            </a>
          </li>
          <li>
            <a className="font-Ovo" onClick={closeMenuHandler} href="#about">
              About me
            </a>
          </li>
          <li>
            <a className="font-Ovo" onClick={closeMenuHandler} href="#services">
              Services
            </a>
          </li>
          <li>
            <a className="font-Ovo" onClick={closeMenuHandler} href="#work">
              My Work
            </a>
          </li>
          {/* <li>
            <a className="font-Ovo" onClick={closeMenuHandler} href="#contact">
              Contact me
            </a>
          </li> */}
        </ul>
